<?php
	...
	*/
	...
	function build_lara_examples() {
		...
		$lara_examples_folder = "../../examples/reflectc/lara/";
	...
	function build_c_examples() {
		...
		$c_examples_folder = "../../examples/reflectc/c/";
	...
	$main_script = "<script src=\"../../scripts/reflectc/reflectc.js?timestamp=" .  rand() . "\" type=\"text/javascript\" charset=\"utf-8\"></script>";
