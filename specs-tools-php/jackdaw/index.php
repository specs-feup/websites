...
<html>
    ...
    <body>
        <header>
            <img src="img/logo-jackdaw-v1.png" class="header_img" alt="JACKDAW" style=""/>
        ...
        <div class="body">
            <div class="sidebar">
                <div class="section">
                    ...
                    <li id="menu-copyright">About Jackdaw</li>
                </div>
                ...
                <div class="section">
                    <h3>Resources</h3>
                    <li><a href="http://specs.fe.up.pt/tools/jackdaw.zip">Download Jackdaw</a></li>
                    <li><a href="http://specs.fe.up.pt/tools/jackdaw/language_specification.html">Language Specification</a></li>
                    <li><a href="http://specs.fe.up.pt/tools/jackdaw/doc/">API Documentation</a></li>
                    <li><a href="https://github.com/specs-feup/jsweaver">GitHub</a></li>
                </div>

                <?php echo get_related_tools('jackdaw') ?>
                                ...
                                <div class="dropdown-menu-container" id="source-code-menu">
                                    <ul class="dropdown-menu">
                                        ...
                                        <ul class="nested-menu" id="code-examples">
                                            <li class="load-code-example">navier-stokes.js</li>
                                            <!--
                                ...
                                <div class="dropdown-menu-container" id="lara-menu">
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="dont-hide expander" data-target="lara-examples">
                                            <i class="fa fa-chevron-right"></i>
                                            <span>LARA Examples</span>
                                        </li>
                                        <ul class="nested-menu" id="lara-examples">
                                            <li class="load-lara-example" data-filename="CallGraph.lara">CallGraph.lara</li>
                                            <!--
                                            <li class="load-lara-example" data-filename="Instrumentation.lara">Instrumentation.lara</li>
                                            <li class="load-lara-example" data-filename="Monitoring.lara">Monitoring.lara</li>
                                            <li class="load-lara-example" data-filename="Hdf5Types.lara">Hdf5Types.lara</li>
                                            <li class="load-lara-example" data-filename="AutoPar.lara">AutoPar.lara</li>
                                            <li class="load-lara-example" data-filename="LibVersioningCompiler.lara">LibVersioningCompiler.lara</li>
                                            <li class="load-lara-example" data-filename="OmpThreadsExplore.lara">OmpThreadsExplore.lara</li>
                                            <li class="load-lara-example" data-filename="DynamicCallGraph.lara">DynamicCallGraph.lara</li>
                                            -->
                                        </ul>
                                        <!--
                                        ...
                                        <ul class="nested-menu" id="lara-matrixmul">
                                            <li class="load-lara-example" data-filename="matrixmul/CodeReport.lara">CodeReport.lara</li>
                                            <li class="load-lara-example" data-filename="matrixmul/Timing.lara">Timing.lara</li>
                                            <li class="load-lara-example" data-filename="matrixmul/Energy.lara">Energy.lara</li>
                                            <li class="load-lara-example" data-filename="matrixmul/Profiling.lara">Profiling.lara</li>
                                            <li class="load-lara-example" data-filename="matrixmul/LoopInterchange.lara">LoopInterchange.lara</li>
                                            <li class="load-lara-example" data-filename="matrixmul/LoopTiling.lara">LoopTiling.lara</li>
                                            <li class="load-lara-example" data-filename="matrixmul/AutoPar.lara">AutoPar.lara</li>
                                            <li class="load-lara-example" data-filename="matrixmul/Margot.lara">Margot.lara</li>
                                        </ul>
                                        -->
                                        <!--
...
<ul class="nested-menu" id="lara-examples">
    ...
    <li class="load-lara-example">AdaptMedianSmooth.lara</li>
                ...
                <div id="about">
                    ...
                    <i>This website presents a demonstration of Jacvkdaw. It does not represent neither the current version of Jackdaw nor the full LARA technology.</i>

                    <h2>Tool</h2>

                    <p>
                        Jackdaw is open-source and is available on <a href="https://github.com/tansvanio/jsweaver" target="_blank">GitHub</a>.
                    </p>
                    ...
                    <p>
                        Jackdaw uses <a href="https://esprima.org/">Esprima</a>, a standard-compliant ECMAScript parser written in ECMAScript.
                    ...
                    <p>João Bispo (<a href="mailto:jbispo@fe.up.pt?Subject=About%20Jackdaw">jbispo@fe.up.pt</a>)</p>
