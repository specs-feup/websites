...
function ompThreadsExplore(markerName, // Name of the LARA marker
    ...
    for (const chain of Query.search("file").search("marker", {id: markerName}).chain()) {
        ...
        // Before the pragma
        $marker.insertBefore(beforeMarker(ompThreadMeasure, commaSeparatedVariables,
...
function beforeMarker(ompThreadMeasure, commaSeparateVariables, threadStart, threadEnd, threadInterval) {
