...
CUpti_PCSamplingCollectionMode collectionMode = CUPTI_PC_SAMPLING_COLLECTION_MODE_CONTINUOUS;

// Command line args variables.
bool disableMerge = false;
bool disablePcInfoPrints = false;
bool disableSourceCorrelation = false;
bool verbose = false;
...
static void PrintRetrievedPcSampData()
{
    for (size_t pcSampBufferIndex = 0; pcSampBufferIndex < buffersRetrievedDataVector.size(); pcSampBufferIndex++)
    {
        ...
        std::cout << "Buffer Number: " << pcSampBufferIndex + 1
                  ...
                  << ", Total Dropped Samples: " << buffersRetrievedDataVector[pcSampBufferIndex].droppedSamples << std::endl;
...
static void SourceCorrelation(CUpti_PCSamplingData *pPcSampDataBuffer, size_t numPcSampDataBuffer)
{
    ...
    for (size_t pcSampBufferIndex = 0; pcSampBufferIndex < numPcSampDataBuffer; pcSampBufferIndex++)
    {
        ...
        std::cout << "Buffer Number: " << pcSampBufferIndex + 1
                  ...
                  << ", Total Dropped Samples: " << pPcSampDataBuffer[pcSampBufferIndex].droppedSamples << std::endl;
