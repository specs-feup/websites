...
typedef struct cudaStreamGetCaptureInfo_v2_params_st {
    cudaStream_t stream;
...
} cudaStreamGetCaptureInfo_v2_params;
...
typedef struct cudaSignalExternalSemaphoresAsync_v2_params_st {
    const cudaExternalSemaphore_t *extSemArray;
    const struct cudaExternalSemaphoreSignalParams *paramsArray;
    unsigned int numExtSems;
    cudaStream_t stream;
} cudaSignalExternalSemaphoresAsync_v2_params;

typedef struct cudaWaitExternalSemaphoresAsync_v2_params_st {
    const cudaExternalSemaphore_t *extSemArray;
    const struct cudaExternalSemaphoreWaitParams *paramsArray;
    unsigned int numExtSems;
    cudaStream_t stream;
} cudaWaitExternalSemaphoresAsync_v2_params;
